...
export const CaseInspectorEdit: React.FC = () => {
    ...
    return (
        <CaseItemContainerStyled>
            {inspectorList && inspectorList.map((el:User, index: number) =>
                <CaseItemStyled key={index} id={el.id.toString()} onClick={selectInspector} color={el.id===selectedInspector ? "red" : ""}>
            ...
            <ButtonContainerStyled>
                ...
                <button>
                    <ButtonSmallStyled color={"red"} onClick={setInspector}>Save</ButtonSmallStyled>
                </button>
            </ButtonContainerStyled>
        </CaseItemContainerStyled>
    )
